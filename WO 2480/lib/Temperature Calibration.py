"""
HFRR Temperature Calibration Report Generator (2-Point: 0 °C & 60 °C)
=====================================================================
...
Save this file e.g. as: C:\\HFRR_Calibration\\generate_temp_report.py
LabVIEW Python Node settings:
    Module Name : generate_temp_report
    Function    : generate_temp_report
"""
...
def generate_temp_report(
    ...
    """
    Generate a Sample Temperature 2-Point Calibration PDF report keeping the exact Stroke design.
    """
    ...
    calibration_name = "Sample Temperature Calibration (2-Point)"
    ...
    filename = f"Temperature_Calibration_{instrument_serial}_{file_safe_time}.pdf"
    ...
    # Dynamic styling and comment selections strictly following instructions
    if pass_fail == "PASS":
        status_card_bg = GREEN_CARD_BG
        status_card_text_color = GREEN_CARD_TXT
        status_comment = f"Sample Temperature Calibration PASSED<br/>Max deviation {max_dev:.3f} °C — within ±{tolerance:g} °C tolerance. Two-point correction applied (0 °C & 60 °C)."
        status_text_style = pass_status_style
    else:
        status_card_bg = RED_CARD_BG
        status_card_text_color = RED_CARD_TXT
        status_comment = "Sample Temperature Calibration Failed<br/>measured Sample Temperature differs from the factory calibration value"
...
if __name__ == "__main__":
    print("=== HFRR Temp Report Generator Test Interface ===")
    try:
        val_0 = float(input("Enter measured value at 0 °C Setpoint (e.g. 0.15): "))
        val_60 = float(input("Enter measured value at 60 °C Setpoint (e.g. 60.20): "))
        
        print("\nProcessing temperature verification logic...")
        
        generated_path = generate_temp_report(
            instrument_serial="HFRR-TEMP-SERIAL",
            operator_name="Local Lab Operator",
            measured_zero=val_0,
